...
async fn test_get_site_type_success() {
    let app = common::spawn_app().await;
    let name = random_name("CD");

    let create_response = app
        .api
        .post("/api/admin/locations/site-types")
        .add_header("Authorization", format!("Bearer {}", app.admin_token))
        .json(&json!({"name": name, "description": "CD"}))
        .await;
    ...
    let response = app
        .api
        .get(&format!("/api/admin/locations/site-types/{}", id))
        .add_header("Authorization", format!("Bearer {}", app.admin_token))
        .await;
...
async fn test_update_site_type_success() {
    ...
    let new_name = random_name("Loja Varejo");

    let response = app
        .api
        .put(&format!("/api/admin/locations/site-types/{}", id))
        .add_header("Authorization", format!("Bearer {}", app.admin_token))
        .json(&json!({"name": new_name, "description": "Desc"}))
        .await;
...
async fn test_delete_site_type_success() {
    ...
    let response = app
        .api
        .delete(&format!("/api/admin/locations/site-types/{}", id))
        .add_header("Authorization", format!("Bearer {}", app.admin_token))
        .await;
...
async fn test_list_site_types_success() {
    ...
    for _ in 0..3 {
        app.api
            .post("/api/admin/locations/site-types")
            .add_header("Authorization", format!("Bearer {}", app.admin_token))
            .json(&json!({"name": random_name("Type")}))
            .await;
    }
...
async fn test_create_site_success() {
    ...
    let site_type_name = random_name("Matriz");
    let site_type: Value = app
        .api
        .post("/api/admin/locations/site-types")
        .add_header("Authorization", format!("Bearer {}", app.admin_token))
        .json(&json!({"name": site_type_name}))
        .await
        .json();

    let site_name = random_name("Sede Central");
...
async fn test_create_site_invalid_city_returns_404() {
    ...
    let site_type: Value = app
        ...
        .post("/api/admin/locations/site-types")
        .add_header("Authorization", format!("Bearer {}", app.admin_token))
        .json(&json!({"name": random_name("Filial")}))
        .await
        .json();
...
async fn test_create_site_duplicate_name_in_same_city_returns_conflict() {
    ...
    let site_type: Value = app
        ...
        .post("/api/admin/locations/site-types")
        .add_header("Authorization", format!("Bearer {}", app.admin_token))
        .json(&json!({"name": random_name("Office")}))
        .await
        .json();

    let site_name = random_name("Unidade Centro");
...
async fn test_create_building_success() {
    ...
    let site_type: Value = app
        ...
        .post("/api/admin/locations/site-types")
        .add_header("Authorization", format!("Bearer {}", app.admin_token))
        .json(&json!({"name": random_name("Campus")}))
        .await
        .json();

    let building_type: Value = app
        .api
        .post("/api/admin/locations/building-types")
        .add_header("Authorization", format!("Bearer {}", app.admin_token))
        .json(&json!({"name": random_name("Admin")}))
        .await
        .json();
...
async fn test_create_space_success() {
    ...
    // Explicitly annotate types to help type inference
    let site_type: Value = app
        .api
        .post("/api/admin/locations/site-types")
        .add_header("Authorization", format!("Bearer {}", app.admin_token))
    ...
    let building_type: Value = app
        ...
        .post("/api/admin/locations/building-types")
        .add_header("Authorization", format!("Bearer {}", app.admin_token))
        .json(&json!({"name": random_name("Tower")}))
        .await
        .json();

    let space_type: Value = app
        .api
        .post("/api/admin/locations/space-types")
        .add_header("Authorization", format!("Bearer {}", app.admin_token))
        .json(&json!({"name": random_name("Room")}))
        .await
        .json();
    ...
    let building: Value = app
        .api
        .post("/api/admin/locations/buildings")
        .add_header("Authorization", format!("Bearer {}", app.admin_token))
        .json(&json!({
            "name": random_name("Main"),
            "site_id": site["id"],
            "building_type_id": building_type["id"]
        }))
        .await
