...
pub async fn seed(enforcer: &mut Enforcer) -> Result<()> {
    ...
    add_crud_policies(
        enforcer,
        ROLE_ADMIN,
        &format!("{}/material-groups", legacy_base),
    )
    .await?;
    ...
    // ========================================================================
    enforcer
        .add_policy(str_vec![ROLE_ADMIN, wh_base, ACTION_GET])
        .await?;
    enforcer
        .add_policy(str_vec![ROLE_ADMIN, wh_base, ACTION_POST])
        .await?;
    enforcer
        .add_policy(str_vec![
            ROLE_ADMIN,
    ...
    enforcer
        .add_policy(str_vec![
            ROLE_ADMIN,
            format!("{}/stocks/{{stock_id}}", wh_base),
            ACTION_GET
        ])
        .await?;
    enforcer
    ...
    enforcer
        .add_policy(str_vec![
            ROLE_ADMIN,
            format!("{}/stocks/{{stock_id}}/block", wh_base),
            ACTION_POST
        ])
        .await?;
    enforcer
        .add_policy(str_vec![
            ROLE_ADMIN,
            format!("{}/stocks/{{stock_id}}/unblock", wh_base),
            ACTION_POST
        ])
        .await?;
    ...
    enforcer
        .add_policy(str_vec![
            ROLE_ADMIN,
            format!("{}/stock/entry", legacy_base),
            ACTION_POST
        ])
        .await?;
    enforcer
    ...
    enforcer
        .add_policy(str_vec![
            ROLE_ADMIN,
            format!("{}/stock/adjustment", legacy_base),
            ACTION_POST
        ])
        .await?;
    enforcer
        .add_policy(str_vec![
            ROLE_ADMIN,
            format!("{}/stock/transfer", legacy_base),
            ACTION_POST
        ])
        .await?;
    enforcer
    ...
    enforcer
        .add_policy(str_vec![
            ROLE_ADMIN,
            format!("{}/stock/{{id}}/maintenance", legacy_base),
            ACTION_PUT
        ])
        .await?;
    enforcer
        .add_policy(str_vec![
            ROLE_ADMIN,
            format!("{}/stock/{{id}}/block", legacy_base),
            ACTION_POST
        ])
        .await?;
    enforcer
    ...
    enforcer
        .add_policy(str_vec![
            ROLE_ADMIN,
            format!("{}/reports/stock-value", legacy_base),
            ACTION_GET
        ])
        .await?;
    enforcer
        .add_policy(str_vec![
            ROLE_ADMIN,
            format!("{}/reports/stock-value/detail", legacy_base),
            ACTION_GET
        ])
        .await?;
    enforcer
        .add_policy(str_vec![
            ROLE_ADMIN,
            format!("{}/reports/consumption", legacy_base),
            ACTION_GET
        ])
        .await?;
    enforcer
        .add_policy(str_vec![
            ROLE_ADMIN,
            format!("{}/reports/most-requested", legacy_base),
            ACTION_GET
        ])
        .await?;
    enforcer
