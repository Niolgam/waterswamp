...
async fn seed_policies(enforcer: &mut Enforcer, pool: &PgPool) -> Result<()> {
    ...
    enforcer
        .add_policy(str_vec![
            ROLE_ADMIN,
            "/api/admin/locations/site-types",
            ACTION_GET
        ])
        .await?;
    enforcer
    ...
    enforcer
        .add_policy(str_vec![
            ROLE_ADMIN,
            "/api/admin/locations/site-types/{id}",
            ACTION_GET
        ])
        .await?;
    enforcer
    ...
    enforcer
        .add_policy(str_vec![
            ROLE_ADMIN,
            "/api/admin/locations/building-types",
            ACTION_GET
        ])
        .await?;
    enforcer
    ...
    enforcer
        .add_policy(str_vec![
            ROLE_ADMIN,
            "/api/admin/locations/building-types/{id}",
            ACTION_GET
        ])
        .await?;
    enforcer
    ...
    enforcer
        .add_policy(str_vec![
            ROLE_ADMIN,
            "/api/admin/locations/space-types",
            ACTION_GET
        ])
        .await?;
    enforcer
    ...
    enforcer
        .add_policy(str_vec![
            ROLE_ADMIN,
            "/api/admin/locations/space-types/{id}",
            ACTION_GET
        ])
        .await?;
    enforcer
    ...
    enforcer
        .add_policy(str_vec![
            ROLE_ADMIN,
            "/api/admin/locations/department-categories",
            ACTION_GET
        ])
        .await?;
    enforcer
    ...
    enforcer
        .add_policy(str_vec![
            ROLE_ADMIN,
            "/api/admin/locations/department-categories/{id}",
            ACTION_GET
        ])
        .await?;
    enforcer
    ...
    enforcer
        .add_policy(str_vec![
            ROLE_ADMIN,
            "/api/admin/locations/buildings/{id}",
            ACTION_GET
        ])
        .await?;
    enforcer
    ...
    enforcer
        .add_policy(str_vec![
            ROLE_ADMIN,
            "/api/admin/geo_regions/countries",
            ACTION_GET
        ])
        .await?;
    enforcer
    ...
    enforcer
        .add_policy(str_vec![
            ROLE_ADMIN,
            "/api/admin/geo_regions/countries/{id}",
            ACTION_GET
        ])
        .await?;
    enforcer
    ...
    enforcer
        .add_policy(str_vec![
            ROLE_ADMIN,
            "/api/admin/geo_regions/states/{id}",
            ACTION_GET
        ])
        .await?;
    enforcer
    ...
    enforcer
        .add_policy(str_vec![
            ROLE_ADMIN,
            "/api/admin/geo_regions/cities/{id}",
            ACTION_GET
        ])
        .await?;
    enforcer
    ...
    enforcer
        .add_policy(str_vec![
            ROLE_ADMIN,
            "/api/admin/budget-classifications/tree",
            ACTION_GET
        ])
        .await?;
    enforcer
        .add_policy(str_vec![
            ROLE_ADMIN,
            "/api/admin/budget-classifications/{id}",
            ACTION_GET
        ])
        .await?;
    enforcer
    ...
    enforcer
        .add_policy(str_vec![
            ROLE_ADMIN,
            "/api/admin/catalog/units-of-measure",
            ACTION_GET
        ])
        .await?;
    enforcer
    ...
    enforcer
        .add_policy(str_vec![
            ROLE_ADMIN,
            "/api/admin/catalog/units-of-measure/{id}",
            ACTION_GET
        ])
        .await?;
    enforcer
    ...
    enforcer
        .add_policy(str_vec![
            ROLE_ADMIN,
            "/api/admin/catalog/conversions/{id}",
            ACTION_GET
        ])
        .await?;
    enforcer
    ...
    enforcer
        .add_policy(str_vec![
            ROLE_ADMIN,
            "/api/admin/organizational/settings",
            ACTION_GET
        ])
        .await?;
    enforcer
    ...
    enforcer
        .add_policy(str_vec![
            ROLE_ADMIN,
            "/api/admin/organizational/settings/{key}",
            ACTION_GET
        ])
        .await?;
    enforcer
    ...
    enforcer
        .add_policy(str_vec![
            ROLE_ADMIN,
            "/api/admin/organizational/organizations/{id}",
            ACTION_GET
        ])
        .await?;
    enforcer
    ...
    enforcer
        .add_policy(str_vec![
            ROLE_ADMIN,
            "/api/admin/organizational/unit-categories",
            ACTION_GET
        ])
        .await?;
    enforcer
    ...
    enforcer
        .add_policy(str_vec![
            ROLE_ADMIN,
            "/api/admin/organizational/unit-categories/{id}",
            ACTION_GET
        ])
        .await?;
    enforcer
    ...
    enforcer
        .add_policy(str_vec![
            ROLE_ADMIN,
            "/api/admin/organizational/unit-types",
            ACTION_GET
        ])
        .await?;
    enforcer
    ...
    enforcer
        .add_policy(str_vec![
            ROLE_ADMIN,
            "/api/admin/organizational/unit-types/{id}",
            ACTION_GET
        ])
        .await?;
    enforcer
    ...
    enforcer
        .add_policy(str_vec![
            ROLE_ADMIN,
            "/api/admin/organizational/units/tree",
            ACTION_GET
        ])
        .await?;
    enforcer
        .add_policy(str_vec![
            ROLE_ADMIN,
            "/api/admin/organizational/units/{id}",
            ACTION_GET
        ])
        .await?;
    enforcer
    ...
    enforcer
        .add_policy(str_vec![
            ROLE_ADMIN,
            "/api/admin/organizational/units/{id}/children",
            ACTION_GET
        ])
        .await?;
    enforcer
        .add_policy(str_vec![
            ROLE_ADMIN,
            "/api/admin/organizational/units/{id}/path",
            ACTION_GET
        ])
        .await?;
    enforcer
        .add_policy(str_vec![
            ROLE_ADMIN,
            "/api/admin/organizational/units/{id}/deactivate",
            ACTION_POST
        ])
        .await?;
    enforcer
        .add_policy(str_vec![
            ROLE_ADMIN,
            "/api/admin/organizational/units/{id}/activate",
            ACTION_POST
        ])
        .await?;
    ...
    enforcer
        .add_policy(str_vec![
            ROLE_ADMIN,
            "/api/admin/organizational/sync/organization",
            ACTION_POST
        ])
        .await?;
    enforcer
        .add_policy(str_vec![
            ROLE_ADMIN,
            "/api/admin/organizational/sync/unit",
            ACTION_POST
        ])
        .await?;
    enforcer
        .add_policy(str_vec![
            ROLE_ADMIN,
            "/api/admin/organizational/sync/org-units",
            ACTION_POST
        ])
        .await?;
    enforcer
        .add_policy(str_vec![
            ROLE_ADMIN,
            "/api/admin/organizational/sync/health",
            ACTION_GET
        ])
        .await?;
    enforcer
        .add_policy(str_vec![
            ROLE_ADMIN,
            "/api/admin/organizational/sync/from-db",
            ACTION_POST
        ])
        .await?;
    enforcer
    ...
    enforcer
        .add_policy(str_vec![
            ROLE_ADMIN,
            "/api/admin/organizational/sync/organization/*/units",
            ACTION_POST
        ])
        .await?;
    ...
    enforcer
        .add_policy(str_vec![
            ROLE_ADMIN,
            "/api/admin/organizational/sync/queue",
            ACTION_GET
        ])
        .await?;
    enforcer
        .add_policy(str_vec![
            ROLE_ADMIN,
            "/api/admin/organizational/sync/queue/stats",
            ACTION_GET
        ])
        .await?;
    enforcer
    ...
    enforcer
        .add_policy(str_vec![
            ROLE_ADMIN,
            "/api/admin/organizational/sync/conflicts",
            ACTION_GET
        ])
        .await?;
    enforcer
    ...
    enforcer
        .add_policy(str_vec![
            ROLE_ADMIN,
            "/api/admin/organizational/sync/conflicts/*/resolve",
            ACTION_POST
        ])
        .await?;
    ...
    enforcer
        .add_policy(str_vec![
            ROLE_ADMIN,
            "/api/admin/organizational/sync/history",
            ACTION_GET
        ])
        .await?;
    enforcer
    ...
    enforcer
        .add_policy(str_vec![
            ROLE_ADMIN,
            "/api/admin/organizational/sync/history/*/review",
            ACTION_POST
        ])
        .await?;
    enforcer
        .add_policy(str_vec![
            ROLE_ADMIN,
            "/api/admin/organizational/sync/history/entity/*/*",
            ACTION_GET
        ])
        .await?;
    ...
    enforcer
        .add_policy(str_vec![
            ROLE_ADMIN,
            "/api/admin/organizational/sync/stats/detailed",
            ACTION_GET
        ])
        .await?;
    enforcer
        .add_policy(str_vec![
            ROLE_ADMIN,
            "/api/admin/organizational/sync/stats/health",
            ACTION_GET
        ])
        .await?;
    ...
    enforcer
        .add_policy(str_vec![
            ROLE_ADMIN,
            "/api/admin/warehouse/material-groups",
            ACTION_GET
        ])
        .await?;
    enforcer
    ...
    enforcer
        .add_policy(str_vec![
            ROLE_ADMIN,
            "/api/admin/warehouse/material-groups/{id}",
            ACTION_GET
        ])
        .await?;
    enforcer
    ...
    enforcer
        .add_policy(str_vec![
            ROLE_ADMIN,
            "/api/admin/warehouse/materials/{id}",
            ACTION_GET
        ])
        .await?;
    enforcer
    ...
    enforcer
        .add_policy(str_vec![
            ROLE_ADMIN,
            "/api/admin/warehouse/warehouses",
            ACTION_POST
        ])
        .await?;
    enforcer
        .add_policy(str_vec![
            ROLE_ADMIN,
            "/api/admin/warehouse/warehouses/{id}",
            ACTION_GET
        ])
        .await?;
    enforcer
    ...
    enforcer
        .add_policy(str_vec![
            ROLE_ADMIN,
            "/api/admin/warehouse/stock/entry",
            ACTION_POST
        ])
        .await?;
    enforcer
        .add_policy(str_vec![
            ROLE_ADMIN,
            "/api/admin/warehouse/stock/exit",
            ACTION_POST
        ])
        .await?;
    enforcer
        .add_policy(str_vec![
            ROLE_ADMIN,
            "/api/admin/warehouse/stock/adjustment",
            ACTION_POST
        ])
        .await?;
    enforcer
        .add_policy(str_vec![
            ROLE_ADMIN,
            "/api/admin/warehouse/stock/transfer",
            ACTION_POST
        ])
        .await?;
    enforcer
    ...
    enforcer
        .add_policy(str_vec![
            ROLE_ADMIN,
            "/api/admin/warehouse/stock/{id}/maintenance",
            ACTION_PUT
        ])
        .await?;
    enforcer
        .add_policy(str_vec![
            ROLE_ADMIN,
            "/api/admin/warehouse/stock/{id}/block",
            ACTION_POST
        ])
        .await?;
    enforcer
    ...
    enforcer
        .add_policy(str_vec![
            ROLE_ADMIN,
            "/api/admin/warehouse/reports/stock-value",
            ACTION_GET
        ])
        .await?;
    enforcer
        .add_policy(str_vec![
            ROLE_ADMIN,
            "/api/admin/warehouse/reports/stock-value/detail",
            ACTION_GET
        ])
        .await?;
    enforcer
        .add_policy(str_vec![
            ROLE_ADMIN,
            "/api/admin/warehouse/reports/consumption",
            ACTION_GET
        ])
        .await?;
    enforcer
        .add_policy(str_vec![
            ROLE_ADMIN,
            "/api/admin/warehouse/reports/most-requested",
            ACTION_GET
        ])
        .await?;
    enforcer
        .add_policy(str_vec![
            ROLE_ADMIN,
            "/api/admin/warehouse/reports/movement-analysis",
            ACTION_GET
        ])
        .await?;
    ...
    enforcer
        .add_policy(str_vec![
            ROLE_ADMIN,
            "/api/admin/requisitions/{id}/fulfill",
            ACTION_POST
        ])
        .await?;
    ...
    enforcer
        .add_policy(str_vec![
            ROLE_ADMIN,
            "/api/admin/requisitions/{id}/cancel",
            ACTION_POST
        ])
        .await?;
    enforcer
        .add_policy(str_vec![
            ROLE_ADMIN,
            "/api/admin/requisitions/{id}/history",
            ACTION_GET
        ])
        .await?;
    enforcer
        .add_policy(str_vec![
            ROLE_ADMIN,
            "/api/admin/requisitions/{id}/rollback-points",
            ACTION_GET
        ])
        .await?;
    enforcer
        .add_policy(str_vec![
            ROLE_ADMIN,
            "/api/admin/requisitions/{id}/rollback",
            ACTION_POST
        ])
        .await?;
    ...
    enforcer
        .add_policy(str_vec![
            ROLE_ADMIN,
            "/api/admin/requisitions/{id}/items",
            ACTION_GET
        ])
        .await?;
    enforcer
        .add_policy(str_vec![
            ROLE_ADMIN,
            "/api/admin/requisitions/{req_id}/items/{item_id}/delete",
            ACTION_POST
        ])
        .await?;
    enforcer
        .add_policy(str_vec![
            ROLE_ADMIN,
            "/api/admin/requisitions/{req_id}/items/{item_id}/restore",
            ACTION_POST
        ])
        .await?;
    ...
    enforcer
        .add_policy(str_vec![
            ROLE_ADMIN,
            "/api/admin/fleet/transmission-types",
            ACTION_GET
        ])
        .await?;
    enforcer
    ...
    enforcer
        .add_policy(str_vec![
            ROLE_ADMIN,
            "/api/admin/fleet/transmission-types/{id}",
            ACTION_GET
        ])
        .await?;
    enforcer
    ...
    enforcer
        .add_policy(str_vec![
            ROLE_ADMIN,
            "/api/admin/fleet/vehicles/search",
            ACTION_GET
        ])
        .await?;
    enforcer
    ...
    enforcer
        .add_policy(str_vec![
            ROLE_ADMIN,
            "/api/admin/fleet/vehicles/{id}/status",
            ACTION_PUT
        ])
        .await?;
    enforcer
        .add_policy(str_vec![
            ROLE_ADMIN,
            "/api/admin/fleet/vehicles/{id}/history",
            ACTION_GET
        ])
        .await?;
    ...
    enforcer
        .add_policy(str_vec![
            ROLE_ADMIN,
            "/api/admin/fleet/vehicles/{id}/documents",
            ACTION_GET
        ])
        .await?;
    enforcer
    ...
    enforcer
        .add_policy(str_vec![
            ROLE_ADMIN,
            "/api/admin/fleet/vehicles/{vehicle_id}/documents/{doc_id}",
            ACTION_DELETE
        ])
        .await?;
    ...
    // ============================
    enforcer
        .add_policy(str_vec![ROLE_ADMIN, "/api/admin/drivers", ACTION_GET])
        .await?;
    enforcer
        .add_policy(str_vec![ROLE_ADMIN, "/api/admin/drivers", ACTION_POST])
        .await?;
    enforcer
        .add_policy(str_vec![ROLE_ADMIN, "/api/admin/drivers/{id}", ACTION_GET])
        .await?;
    enforcer
        .add_policy(str_vec![ROLE_ADMIN, "/api/admin/drivers/{id}", ACTION_PUT])
        .await?;
    enforcer
        .add_policy(str_vec![
            ROLE_ADMIN,
    ...
    enforcer
        .add_policy(str_vec![
            ROLE_ADMIN,
            "/api/admin/vehicle-fines/fine-types",
            ACTION_GET
        ])
        .await?;
    enforcer
    ...
    enforcer
        .add_policy(str_vec![
            ROLE_ADMIN,
            "/api/admin/vehicle-fines/fine-types/{id}",
            ACTION_GET
        ])
        .await?;
    enforcer
    ...
    enforcer
        .add_policy(str_vec![
            ROLE_ADMIN,
            "/api/admin/vehicle-fines/fines/{id}",
            ACTION_GET
        ])
        .await?;
    enforcer
    ...
    enforcer
        .add_policy(str_vec![
            ROLE_ADMIN,
            "/api/admin/vehicle-fines/fines/{id}/restore",
            ACTION_PUT
        ])
        .await?;
    enforcer
        .add_policy(str_vec![
            ROLE_ADMIN,
            "/api/admin/vehicle-fines/fines/{id}/status",
            ACTION_PUT
        ])
        .await?;
    enforcer
        .add_policy(str_vec![
            ROLE_ADMIN,
            "/api/admin/vehicle-fines/fines/{id}/history",
            ACTION_GET
        ])
        .await?;
